import { Carousel, Dropdown, Input, MenuProps } from "antd";
...
export default function LandingPage() {
  ...
  console.log(isLogin);
  const { data: createdMeet, mutate } = useMutation(["create-meet"], async () =>
    query<any, MeetModel>({
      url: "/meet",
      tokenRequired: true,
      ...
      <div className="flex py-28 px-44 items-center">
        <div className="flex flex-col flex-1 gap-10">
          <h1 className="text-4xl ">
            Cuộc họp video chất lượng. <br /> Giờ đây miễn phí cho tất cả <br />{" "}
            mọi người.
          </h1>
          <p className="w-96">
